...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleInvalidLoanApplication(InvalidLoanApplicationException exception) {

        Map<String, Object> response = new HashMap<>();
        response.put("timestamp", LocalDateTime.now());
        response.put("status", HttpStatus.BAD_REQUEST.value());
        response.put("error", "Invalid Loan Application");
        response.put("message", exception.getMessage());
    ...
    public ResponseEntity<Map<String, Object>> handleFeignException(FeignException exception) {
        ...
        response.put("message", "Required service is not available. Please try again later.");
